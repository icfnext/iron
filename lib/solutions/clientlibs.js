...
module.exports = function( answers ){
    ...
    var lib = {
        ...
        entry               : {
            ...
            style : '/client-libraries/' + answers.clientlib_name + '/styles/' + answers.clientlib_name + '.' + ironRc.css_preprocessor !== false ? ironRc.css_preprocessor : 'css'
        },
        components          : answers.components ? answers.components : [],
        defaultComponents   : answers.clientlib_default_components,
        styleType           : ironRc.css_preprocessor !== false ? ironRc.css_preprocessor : 'css'
    }
