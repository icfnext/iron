...
module.exports = function( program ){
    ...
    utils.templateRenderer( bundlePath + '/main.' + bundleInfo.bundle_name + '.js', templates.bundles.mainJs.value, bundleInfo )
    utils.templateRenderer( bundlePath + '/styles/' + bundleInfo.bundle_name + '.scss', templates.bundles.mainCSS.value, bundleInfo )
